...
export const STATUS_BADGE_STYLES: Record<string, { label: string; className: string }> = {
  ...
  CANCELLED: {
    label: "Cancelled",
    className: "bg-gray-100 text-gray-600 border-gray-300 dark:bg-gray-800/30 dark:text-gray-300 dark:border-gray-600",
  },
};
...
export const ROLE_BADGE_STYLES: Record<string, { className: string }> = {
  ...
  EMPLOYEE: {
    className:
      "bg-slate-100 text-slate-700 border-slate-300 dark:bg-slate-800/30 dark:text-slate-300 dark:border-slate-600",
  },
};
